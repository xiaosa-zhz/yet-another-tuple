#ifndef STD_GENERATOR_REFERENCE_IMPLEMENTATION_H
#define STD_GENERATOR_REFERENCE_IMPLEMENTATION_H 1
...
namespace std {
    ...
    namespace ranges {
        ...
        template<class _Elem, class _Alloc = allocator<byte>>
        elements_of(std::initializer_list<_Elem>, _Alloc = {}) -> elements_of<std::initializer_list<_Elem>, _Alloc>;
    } // namespace ranges
...
#endif // !STD_GENERATOR_REFERENCE_IMPLEMENTATION_H
